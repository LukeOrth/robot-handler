                ...
                <li class="nav-item">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li>
                                <a class="dropdown-item" @click="showHideModal" aria-current="page" href="#" data-bs-toggle="modal" data-bs-target="#settingsModal">
                                    Update Directories
                                </a>
                            </li>
                            <li>
                                <div class="d-grid gap-2">
                                    <button type="button" class="btn btn-danger mx-1 mt-2 btn">Update Tests</button>
                                </div>
                            </li>
                        </ul>
                    </div>
