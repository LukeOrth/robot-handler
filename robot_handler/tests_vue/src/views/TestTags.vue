        ...
        <div class="row mt-2">
            <div class="col">
                ...
                <div v-if="dataLoaded" class="accordion accordion-flush" id="accordionFlushExample">
                    ...
                    <div v-for="test_tag in testTags" v-bind:key="test_tag.id" class="accordion-item">
                        <h2 class="accordion-header" id="flush-headingOne">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                :data-bs-target="`#flush-${test_tag.id}`" aria-expanded="false"
                                :aria-controls="`flush-${test_tag.id}`">
                                {{ test_tag.name }}
                            </button>
                        </h2>
                        <div :id="`flush-${test_tag.id}`" class="accordion-collapse collapse show"
                            aria-labelledby="flush-headingOne">
                            <div class="accordion-body">
                                <div class="row row-cols-1 row-cols-md-3 g-4">
                                    <div v-for="test_suite in test_tag.test_suites" v-bind:key="test_suite.id"
                                        class="col">
                                        <div class="card">
                                            ...
                                            <div class="card-footer">
                                                <small class="float-start me-2">Tags: </small>
...
export default {
    ...
    setup() {
        ...
        return { dataLoaded, testCaseId, testSuiteId, loadTestCaseModal, loadTestSuiteModal, noData, error, testCategories, testSuites, testCases, testTags };
    },
}
</script>
